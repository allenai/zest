...
"""Fine-tune T5 on the zest dataset."""
...
# mixture gets registered and is available for training.
...
@click.option(
    ...
    type=int,
    default=25000,
    help="The number of fine-tuning steps (gradient updates) to run. Defaults"
    " to 25,000",
)
@click.option(
    "--learning-rate",
